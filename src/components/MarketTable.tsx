    ...
    <div className="space-y-6 animate-fade-in">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-effect p-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300">
          <div className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-3">Bitcoin</div>
          <div className={`text-3xl font-bold ${btcStatus.status === 'bullish' ? 'text-green-500' : 'text-red-500'} mb-3`}>
            ${btcStatus.price}
          </div>
      ...
      <div className="bg-white/50 dark:bg-gray-800/50 p-6 rounded-xl shadow-lg backdrop-blur-sm">
        <h3 className="text-xl font-bold mb-4 text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700 pb-3">
          Top Trades
        </h3>
          ...
          {topTrades.map((trade) => {
            ...
            return (
              <div key={trade.symbol} 
                className="glass-effect p-4 rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-300 animate-fade-in">
